...
<body>
	<div id="panelMain">
		...
		<div class="row">
			<div class="col-lg-12">
				<h2>
					สถานะ<small> (รายละเอียดสถานะการอนุมัติ)</small>
				</h2>
			</div>
		</div>
		...
		<div id="insertdata"
			...
			<label
				style="font-weight: bold; padding-top: 10pt; font-size: 14pt; font-weight: bold; padding-left: 20pt">เพิ่มสถานะ</label>
			...
			<table class="table table-striped table-bordered table-hover">
				<thead>
					<tr>
						...
						<td style="font-weight: bold; font-size: 13pt;">ชื่อสถานะ</td>
